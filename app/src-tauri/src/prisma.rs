...
pub mod issue {
	...
	pub fn create(
		url: String,
		title: String,
		topic: super::source::UniqueWhereParam,
		_params: Vec<SetParam>,
	) -> (
		String,
		String,
	...
	pub struct Data {
		...
		#[serde(rename = "topic")]
		#[specta(skip)]
		pub topic: Option<Box<super::source::Data>>,
	...
	pub enum SetParam {
		...
		SetUrl(String),
		SetTitle(String),
		ConnectTopic(super::source::UniqueWhereParam),
		SetTopicId(i32),
	...
	pub enum WhereParam {
		...
		TitleEquals(String),
		Title(_prisma::read_filters::StringFilter),
		TopicIs(Vec<super::source::WhereParam>),
		TopicIsNot(Vec<super::source::WhereParam>),
		TopicIdEquals(i32),
